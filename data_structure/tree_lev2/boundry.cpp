...
void leftboundry(BinaryTreeNode<int>*root){
	if(root==NULL)return;
	if(root->left){
	cout<<root->data<<" ";
...
void rightboundry(BinaryTreeNode<int>*root){
	if(root==NULL)return;
	if(root->right){
	leftboundry(root->right);
	cout<<root->data<<" ";
...
void leavenodes(BinaryTreeNode<int>*root){
	if(root==NULL)return;
...
void boundry(BinaryTreeNode<int>*root){
	if(root==NULL)return;
	cout<<root->data<<" ";
	leftboundry(root->left);
	leavenodes(root);
